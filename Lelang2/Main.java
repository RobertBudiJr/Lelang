...
public class Main {
    ...
    static void generatebarang() {
        barangLelang.addNamaBarang("Leptop");
        barangLelang.addHargaAwal("1000000");
        barangLelang.addHargaTawar(1000000);
        barangLelang.setStatus(true);

        barangLelang.addNamaBarang("Hape");
        barangLelang.addHargaAwal("300000");
        barangLelang.addHargaTawar(300000);
        barangLelang.setStatus(true);

        barangLelang.addNamaBarang("Mesin cuci");
